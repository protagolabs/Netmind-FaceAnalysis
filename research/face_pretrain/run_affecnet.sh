...
# OMP_NUM_THREADS=1 python -m torch.distributed.launch --nproc_per_node=4 main_finetune_affecnet.py \
#     --accum_iter 1 \
#     --batch_size 64 \
...
#     --output_dir "ft_affecnet_dino_ms1m_vits16" \
#     --dist_eval --nb_classes 8 --data_path ${IMAGENET_DIR}
